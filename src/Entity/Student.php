...
class Student implements UserInterface
{
    ...
    #[Assert\NotBlank(message: "Grade Level is required")]
    #[Assert\Length(max: 255, maxMessage: "Grade Level cannot exceed {{ limit }} characters")]
    #[ORM\Column(name: "currentGradeLevel", type: "string", length: 255)]
    private $currentGradeLevel;

    #[Assert\NotBlank(message: "Major Level is required")]
    #[Assert\Length(max: 255, maxMessage: "Major cannot exceed {{ limit }} characters")]
    #[ORM\Column(type: "string", length: 255)]
    private $major;
    ...
    {
        $this->userType = 'student'; // Set the user type to 'student'
    ...
    /**
     * @param mixed $currentGradeLevel
     */
    public function setCurrentGradeLevel($currentGradeLevel): void
    {
