...
class Instructor implements UserInterface
{
    ...
    #[ORM\Column(name: "yearsOfExperience", type: "integer")]
    private $yearsOfExperience;

    #[Assert\NotBlank(message: "Bio type is required")]
    #[Assert\Length(min: 10, max: 255, maxMessage: "Bio cannot exceed {{ limit }} characters")]
    ...
    {
        $this->userType = 'instructor'; // Set the user type to 'admin'
