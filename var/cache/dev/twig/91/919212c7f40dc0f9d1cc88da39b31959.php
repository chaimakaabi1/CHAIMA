...
class __TwigTemplate_364429850314a9a3bdfaaed5ba9eeb0b extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\" action=\"{{ path('admin_dashboard_admins_delete', {'id': admin.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ admin.id) }}\">
    <button class=\"btn danger\">Delete</button>
</form>
", "admin/_delete_form.html.twig", "C:\\Users\\hassa\\Videos\\CoursifyWeb\\templates\\admin\\_delete_form.html.twig");
    }
}
