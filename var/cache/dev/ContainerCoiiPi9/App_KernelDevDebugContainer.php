...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\CmntController' => 'getCmntControllerService',
            ...
            'App\\Controller\\InstructorDashboardController' => 'getInstructorDashboardControllerService',
            'App\\Controller\\Payment1Controller' => 'getPayment1ControllerService',
            'App\\Controller\\PaymentController' => 'getPaymentControllerService',
            'App\\Controller\\PostController' => 'getPostControllerService',
            'App\\Controller\\ProfController' => 'getProfControllerService',
            ...
            'App\\Controller\\StudentDashboardController' => 'getStudentDashboardControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('OIddqfI6l4', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wTi+Cb0IeI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('U90ELbG-H9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\ChapitrefileRepository' => ['privates', 'App\\Repository\\ChapitrefileRepository', 'getChapitrefileRepositoryService', true],
            'App\\Repository\\ChapitrequizzRepository' => ['privates', 'App\\Repository\\ChapitrequizzRepository', 'getChapitrequizzRepositoryService', true],
            'App\\Repository\\CmntRepository' => ['privates', 'App\\Repository\\CmntRepository', 'getCmntRepositoryService', true],
            ...
            'App\\Repository\\InstructorRepository' => ['privates', 'App\\Repository\\InstructorRepository', 'getInstructorRepositoryService', true],
            ...
            'App\\Repository\\ChapitrefileRepository' => '?',
            'App\\Repository\\ChapitrequizzRepository' => '?',
            'App\\Repository\\CmntRepository' => '?',
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VKbADvalFM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('rv3TZrpmJJ', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('C3lkv9mDUv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wNFEoDFesf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TCXUNvwCFX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iJNxga1ntW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Q0nUYsgTbv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getSecurity_ContextListener_0Service()
    {
        return $this->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.user.provider.concrete.app_admin_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppAdminProviderService'));
            yield 1 => ($this->privates['security.user.provider.concrete.app_student_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppStudentProviderService'));
            yield 2 => ($this->privates['security.user.provider.concrete.app_instructor_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppInstructorProviderService'));
            yield 3 => ($this->privates['security.user.provider.concrete.app_users'] ?? $this->load('getSecurity_User_Provider_Concrete_AppUsersService'));
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Validator\\Constraints\\CourseTitleExistsValidator' => ['privates', 'App\\Validator\\Constraints\\CourseTitleExistsValidator', 'getCourseTitleExistsValidatorService', true],
            'App\\Validator\\Constraints\\NoBadWordsValidator' => ['privates', 'App\\Validator\\Constraints\\NoBadWordsValidator', 'getNoBadWordsValidatorService', true],
            'App\\Validator\\Constraints\\UniqueUserDetailsValidator' => ['privates', 'App\\Validator\\Constraints\\UniqueUserDetailsValidator', 'getUniqueUserDetailsValidatorService', true],
            ...
            'App\\Validator\\Constraints\\CourseTitleExistsValidator' => '?',
            'App\\Validator\\Constraints\\NoBadWordsValidator' => '?',
            'App\\Validator\\Constraints\\UniqueUserDetailsValidator' => '?',
