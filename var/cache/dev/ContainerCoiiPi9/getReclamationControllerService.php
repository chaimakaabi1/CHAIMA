...
class getReclamationControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.9Sq.cKZ'] ?? $container->load('get_ServiceLocator_9Sq_CKZService'))->withContext('App\\Controller\\ReclamationController', $container));
