...
class getRegistrationControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.VNYrXmz'] ?? $container->load('get_ServiceLocator_VNYrXmzService'))->withContext('App\\Controller\\RegistrationController', $container));
