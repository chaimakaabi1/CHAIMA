 ...
 */
class getChapitrefileRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChapitrefileRepository' shared autowired service.
     *
     * @return \App\Repository\ChapitrefileRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChapitrefileRepository.php';

        return $container->privates['App\\Repository\\ChapitrefileRepository'] = new \App\Repository\ChapitrefileRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
