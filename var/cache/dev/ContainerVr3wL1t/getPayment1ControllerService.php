...
class getPayment1ControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.VNYrXmz'] ?? $container->load('get_ServiceLocator_VNYrXmzService'))->withContext('App\\Controller\\Payment1Controller', $container));
