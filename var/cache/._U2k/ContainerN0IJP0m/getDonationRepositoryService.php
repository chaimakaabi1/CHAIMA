...
class getDonationRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DonationRepository.php';

        return $container->privates['App\\Repository\\DonationRepository'] = new \App\Repository\DonationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
