...
class App_KernelDevDebugContainer extends Container
{
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'twilio_account_sid': $value = $this->getEnv('TWILIO_ACCOUNT_SID'); break;
            case 'twilio_auth_token': $value = $this->getEnv('TWILIO_AUTH_TOKEN'); break;
            case 'twilio_phone_number': $value = $this->getEnv('TWILIO_PHONE_NUMBER'); break;
