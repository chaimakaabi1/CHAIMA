 ...
 */
class getCmntRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CmntRepository' shared autowired service.
     *
     * @return \App\Repository\CmntRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CmntRepository.php';

        return $container->privates['App\\Repository\\CmntRepository'] = new \App\Repository\CmntRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
