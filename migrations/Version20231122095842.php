 ...
 */
final class Version20231122095842 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reset_password_request ADD admin_id INT DEFAULT NULL, ADD instructor_id INT DEFAULT NULL, ADD student_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reset_password_request DROP admin_id, DROP instructor_id, DROP student_id');
    }
}
