 ...
 */
final class Version20231122113139 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reset_password_request ADD user_id INT NOT NULL, DROP admin_id, DROP student_id, DROP instructor_id, DROP user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reset_password_request ADD admin_id INT DEFAULT NULL, ADD student_id INT DEFAULT NULL, ADD instructor_id INT DEFAULT NULL, ADD user VARCHAR(255) DEFAULT NULL, DROP user_id');
