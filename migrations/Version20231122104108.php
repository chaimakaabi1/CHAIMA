 ...
 */
final class Version20231122104108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reset_password_request ADD user_type VARCHAR(255) NOT NULL, ADD user_id INT NOT NULL, DROP admin_id, DROP instructor_id, DROP student_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE reset_password_request ADD admin_id INT DEFAULT NULL, ADD instructor_id INT DEFAULT NULL, ADD student_id INT DEFAULT NULL, DROP user_type, DROP user_id');
